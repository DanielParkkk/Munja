...
class LoadImages:
    ...
    def __next__(self):
        ...
        # 임의 crop
        origin_img = img0.copy()       
        coord = img_crop.crop_magic(img0) # 주요 실행 코드
        img0 = img0[coord[1]:coord[3], coord[0]:coord[2]]
        ...
        return path, img, img0, self.cap, s, origin_img, coord[0], coord[1]
